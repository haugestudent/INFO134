...
var text = '{"entries":[' +
'{"Id":1,"plassering":"Nonneseter Sør","place":"Nonneseter South","adresse":"Lungegårdskaien","pris": 12,"start_hverdag":"07:00","slutt_hverdag":"23:15","start_lørdag":"07:00","slutt_lørdag":"23:15","start_søndag":"07:00","slutt_søndag":"23:15", "rullestol": "Ja" , "stellerom": "Nei" , "pissOnly": "Nei","lat": 60.388076, "long": 5.334937 },' +
'{"Id":2,"plassering":"Nonneseter Nord","place":"Nonneseter North","adresse":"Østre Strømkai","pris": 12,"start_hverdag":"05:30","slutt_hverdag":"23:50","start_lørdag":"07:00","slutt_lørdag":"23:15","start_søndag":"Stengt","slutt_søndag":"Stengt", "rullestol": "Ja" , "stellerom": "Nei" , "pissOnly": "Nei","lat": 60.388871, "long": 5.334079 },' +
...
//Finne ut om det er hverdag, lørdag eller søndag, og tildele variablene korrekt ukedag
  ...
  if ((timeStart < timeNaa) && (timeSlutt > timeNaa)) {
    ...
    var minuttSjekkStart;
    var minuttSjekkSlutt;
    //Sjekker minuttene ved åpning dersom timetallet er likt
    if (timeStart == timeNaa) {

      if (minuttStart <= minuttNaa) {
        minuttSjekkStart = true;
      } else {
        minuttSjekkStart = false;
      }
    } else {
      minuttSjekkStart = false;
    }

    //Sjekker minuttene ved stenging dersom timetallet er likt
  if (timeSlutt == timeNaa) {

    if (minuttSlutt > minuttNaa) {
      minuttSjekkSlutt = true;
      } else {
        minuttSjekkSlutt = false;
      }
      return minuttSjekkStart && minuttSjekkSlutt;
  }
  //Hvis timetallet for åpning er større enn timetallet nå, eller
  //hvis timetallet for lukking er lavere enn timetallet nå, er
  //det stengt.
  else {
    return false;
  }
