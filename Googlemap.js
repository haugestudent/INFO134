...
'{"Id":14,"plassering":"C. Sundtsgt","place":"C. Sundtsgt","Adresse":"C. Sundtsgt","pris": 0,"tid_hverdag":"Hele døgnet","tid_lørdag":"Hele døgnet","tid_søndag":"Hele døgnet", "rullestol": false , "stellerom": false , "pissOnly": true,"lat": 60.397359, "long": 5.313963 },' +
...
function finnAlleToalett() {
  ...
  for (i = 0; i < obj.entries.length; i++) {
    document.getElementById("toalett").innerHTML +=  "<button class=\"link\" id =\"buttonId" + i + "\">" 
	+ obj.entries[i].plassering + "</button><br>";
  }
